    ...
    <div className="space-y-5 p-6">
      <div className="grid grid-cols-1 gap-5 md:grid-cols-3">
        <KpiCard
          ...
          label="My reimbursed"
          value={rupee(d.myReimbursed)}
          valueTone="green"
          delta="Paid out"
          deltaTone="green"
          footer="Total reimbursed to you"
        />
        <KpiCard
          icon={<Receipt size={15} />}
          label="My in-progress"
          value={rupee(d.myPending)}
          delta="Pending + approved"
          deltaTone="amber"
          footer="Awaiting reimbursement"
        />
        <KpiCard
          icon={<BadgeIndianRupee size={15} />}
          label="Org pending approval"
          value={rupee(d.orgPending)}
          delta="Across company"
          deltaTone="blue"
          footer="Claims awaiting review"
        />
      </div>
