...
describe('hoursBetween', () => {
  ...
  it('rounds partial hours to 2 decimals', () => {
    expect(hoursBetween('2026-07-08T09:00:00Z', '2026-07-08T09:45:00Z')).toBe(
      0.75,
    )
    expect(hoursBetween('2026-07-08T09:00:00Z', '2026-07-08T10:20:00Z')).toBe(
      1.33,
    )
  })
  ...
  it('is timezone-agnostic (compares absolute instants)', () => {
    ...
    expect(
      hoursBetween('2026-07-08T09:00:00+05:30', '2026-07-08T05:30:00Z'),
    ).toBe(2)
  })
